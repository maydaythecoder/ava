...
/**
 * Login Page
 * Email/password login with GitHub OAuth and magic link options
 */
...
export default function LoginPage() {
  ...
  return (
    <AuthLayout>
      <form
        onSubmit={showMagicLink ? handleMagicLink : handleEmailLogin}
        ...
        {!showMagicLink && (
          <div className="flex items-center justify-between">
            <button
              ...
              className="text-sm font-semibold text-purple-600 hover:text-purple-500 dark:text-purple-400"
            >
